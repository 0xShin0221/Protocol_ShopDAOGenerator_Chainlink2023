...
task(
  "functions-sub-add",
  "Adds a client contract to the Functions billing subscription"
)
  .addParam("subid", "Subscription ID")
  .addParam(
    "contract",
    "Address of the Functions client contract to authorize for billing"
  )
...
module.exports.addClientConsumerToSubscription =
  addClientConsumerToSubscription;

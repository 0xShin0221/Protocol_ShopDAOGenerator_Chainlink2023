...
export interface GovernorSettingsCInterface extends utils.Interface {
  functions: {
...
export interface GovernorSettingsC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorSettingsCInterface;

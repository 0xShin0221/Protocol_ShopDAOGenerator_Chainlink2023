...
export interface GovernorCountingSimpleCInterface extends utils.Interface {
  functions: {
...
export interface GovernorCountingSimpleC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorCountingSimpleCInterface;

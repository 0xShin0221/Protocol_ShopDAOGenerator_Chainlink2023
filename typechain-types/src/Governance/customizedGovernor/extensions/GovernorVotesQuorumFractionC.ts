...
export interface GovernorVotesQuorumFractionCInterface extends utils.Interface {
  functions: {
...
export interface GovernorVotesQuorumFractionC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorVotesQuorumFractionCInterface;

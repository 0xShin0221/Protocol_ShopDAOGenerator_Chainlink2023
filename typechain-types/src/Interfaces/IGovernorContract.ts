...
export interface IGovernorContractInterface extends utils.Interface {
  functions: {
    "init(string,address,address,uint256,uint256,uint256)": FunctionFragment;
  };
...
export interface IGovernorContract extends BaseContract {
  ...
  interface: IGovernorContractInterface;

 ...
 AccessControl
{
 ...
 address immutable profitNFT = 0xF70488D0A20746cFd93830fF2aF97690b24a588E;
 /// Error 
   ...
   external 
 {
   ...
   _grantRole(BRAND_MANAGER_ROLE, _sortedProposalList);
   _grantRole(BRAND_MANAGER_ROLE, _sortedQueueAndExecutionList);
